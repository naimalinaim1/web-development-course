...
const addToLiked = (id) => {
  const isExi = likedPostsId.indexOf(id)
  if (isExi !== -1) {
    likedPostsId.splice(isExi, 1);
  } else if(isExi) {
...
const displayLikedPosts = () => {
  const postCon = document.getElementById( "liked" );
  postCon.innerHTML = '';
...
const displayReportedPosts = () => {
  const postCon = document.getElementById( "reported" );
  postCon.innerHTML = '';
