...
const Register = () => {
  ...
  const handleRegister = (e) => {
    ...
    const number = form.floating_phone.value;
  ...
  return (
    <div className="h-screen flex items-center bg-sky-100/50">
      <div className="w-[50%] max-w-[600px] mx-auto">
        <h2 className="text-3xl font-semibold text-center">App Register</h2>
        <form
          onSubmit={handleRegister}
          className="border-2  p-4 rounded-md mt-10"
        >
